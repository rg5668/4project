...
<div class="w3-display-container w3-container">
    ...
    <c:if test="${session eq 'admin'}">
  	...
  	style="margin-top: 20px">상품올리기&nbsp;</a>
  	</c:if>
  	
  	</font>
</div>
  	
  <p style="font-size: 15px">신상품순</p>
  </div>
...
<c:forEach  var="b" items="${pro }" begin="0" end="3">
    ...
    <input type="button" value="상품수정" class="w3-button w3-black w3-margin-bottom"></a>
    <a href="pdeleteForm?pcode=${b.pcode }">
    <input type="button" value="상품삭제" class="w3-button w3-black w3-margin-bottom"></a>
    </c:if>
    </td>  
</c:forEach>
</tr>
