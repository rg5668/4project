   ...
   <h3>회원정보수정/탈퇴</h3>
	...
	<table id="tab" style="width:100%">
		<tr><th><label>이름</label></th>
        	<td> <input type="text" name="name" style="width:80%" value="${mem.getName()}">
        	</td></tr>
		<tr><th><label>비밀번호 </label>
       		</th><td> <input type="password" name="pass" style="width:80%" value="${mem.getPass() }">
        	</td></tr>
        <tr><th><label>주소 </label></th>
       		<td> <input type="text" name="address" style="width:80%" value="${mem.getAddress() }">
        	</td></tr>
        <tr><th><label>생년월일 </label>
       		</th><td> <input type="text" name="birth" style="width:80%" value="${ mem.getBirth()}">
        	</td> </tr>
         <tr><th><label>전화번호 </label></th>
        	<td><input type="text" name="tel" style="width:80%" value="${ mem.getTel()}">
        	</td></tr></table><br>
	<div align="center">
   <button type="submit" class="succ btn" formaction='mypageupdate'>수정하기</button>
   <button type="submit" class="clear btn" formaction='mypagedelete'>탈퇴하기</button>
   </div></form>
</div></div></div></body>